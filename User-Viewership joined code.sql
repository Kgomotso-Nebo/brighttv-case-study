...
LIMIT 10; -- checking for duplicates in my data 

SELECT UserID,  
COUNT(*) AS duplicate_count 
FROM brighttv.brighttv.bright_tv_dataset_user_profiles 
GROUP BY UserID 
HAVING COUNT(*) > 1; -- I am checking the size pf the data 

SELECT COUNT(*) AS number_of_rows, 
COUNT(DISTINCT UserID) AS number_subs 
FROM brighttv.brighttv.bright_tv_dataset_user_profiles; -- Are the any rows where useRID is NULL  
